...
Table = zeros(x,y);
idx1 = 18; Table(idx1) = 1; idx2 = 19; Table(idx2) = 1; idx3 = 28; Table(idx3) = 1;
idx4 = 36; Table(idx4) = 1; idx5 = 38; Table(idx5) = 1; idx6 = 46; Table(idx6) = 1;
idx7 = 47; Table(idx7) = 1; idx8 = 53; Table(idx8) = 1; idx9 = 54; Table(idx9) = 1;
idx10 = 62;Table(idx10) = 1;idx11 = 64; Table(idx11) = 1;
idx12 = 74; Table(idx12) = 1;
...
t=title('Eater And Glider','Color','black');
t.FontSize = 12;
t.FontAngle = 'italic';
